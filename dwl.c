...
#define WALLPAPER_PATH "/home/ricardo/.config/dwl/wallpaper.png"
...
typedef struct {
	...
	struct wlr_scene_rect *border[12]; /* 3 nested bands (outer,mid,inner) x (top,bottom,left,right) */
...
setup(void)
{
	...
	xdg_decoration_mgr = wlr_xdg_decoration_manager_v1_create(dpy, 1);
